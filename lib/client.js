window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$1 = "._85mIGq_wrap{align-items:center;display:inline-flex;position:relative}._85mIGq_mic,._85mIGq_micActive{width:28px;height:28px;color:var(--ds-color-text-secondary,#8a8f98);cursor:pointer;background:0 0;border:none;border-radius:6px;justify-content:center;align-items:center;transition:color .15s,background .15s;display:inline-flex;position:relative}._85mIGq_mic:hover{color:var(--ds-color-text-primary,#e8eaed);background:var(--ds-color-bg-hover,#ffffff14)}._85mIGq_micActive{color:#fff;background:var(--ds-color-danger,#e5484d);animation:1.2s ease-in-out infinite _85mIGq_pulse}._85mIGq_icon{width:16px;height:16px}._85mIGq_overlay,._85mIGq_overlayError{white-space:pre-wrap;word-break:break-word;z-index:30;background:var(--ds-color-bg-elevated,#2a2b30);min-width:120px;max-width:340px;color:var(--ds-color-text-primary,#e8eaed);pointer-events:none;border-radius:8px;padding:6px 10px;font-size:12px;line-height:1.4;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%);box-shadow:0 4px 16px #00000059}._85mIGq_overlayError{color:#ffb4b8;background:#3d1f21}@keyframes _85mIGq_pulse{0%,to{opacity:1}50%{opacity:.55}}";
